...
export default function CustomSearch() {
  ...
  return (
    <View className='mt-6 relative'>
      <Input className={`border-gray-500 bg-white dark:bg-slate-950 h-11 rounded-2xl ${isRtl ? 'pe-10' : 'ps-10'} dark:text-white`} placeholder={t('shipments.searchPlaceholder')} placeholderTextColor={isDark ? 'white' : 'gray'} />
